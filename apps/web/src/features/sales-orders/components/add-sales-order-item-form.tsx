...
import { addSalesOrderItemAction } from "../actions";
...
export function AddSalesOrderItemForm({
  organizationId,
  salesOrderId,
  products,
}: Props) {
  const action = addSalesOrderItemAction.bind(
    null,
    organizationId,
    salesOrderId,
  );
  ...
  return (
    <form action={formAction} className="grid gap-4 md:grid-cols-4">
      ...
      <div className="space-y-2">
        ...
        <Input name="unitPrice" placeholder="149.99" required />
      </div>
